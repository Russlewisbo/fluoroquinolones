...
[Link to HTML slides] (https://russlewisbo.github.io/fluoroquinolones/fluoroquinolone-slides.html#/fluoroquinolones)
...
The quinolone nucleus and key structural modifications are shown in @fig-structures [@domagala1994structure; @wolfson1989fluoroquinolone].

![Quinolone chemical structures](fluoroquinolone-images/structures.png){#fig-structures fig-align="center" width="80%"}

### DNA Gyrase

DNA gyrase is an essential bacterial enzyme composed of two A and two B subunits (products of the *gyrA* and *gyrB* genes) [@drlica1997gyrase]. Its functions include:
...
![DNA gyrase function and quinolone mechanism of action](fluoroquinolone-images/moa.png){#fig-moa fig-align="center" width="80%"}
...
Topoisomerase IV is another type II topoisomerase composed of two subunits encoded by *parC* and *parE* genes [@kato1990topoisomerase]. It functions to:
...
![Topoisomerase IV decatenation function](fluoroquinolone-images/Topof.png){#fig-topoiv fig-align="center" width="80%"}
...
Quinolones bind specifically to the complex of DNA gyrase and DNA (not to DNA gyrase alone). Single *gyrA* or *gyrB* mutations can produce quinolone resistance [@kohanski2007common].
...
These RND-family pumps have broad substrate profiles, contributing to multidrug resistance [@poole2000efflux; @piddock2006efflux].
...
The *qnr* genes encode pentapeptide repeat proteins that protect DNA gyrase and topoisomerase IV from quinolone action. Seven families exist: *qnrA*, *qnrB*, *qnrS*, *qnrC*, *qnrD*, *qnrE*, and *qnrVC* [@martinez1998quinolone; @tran2002plasmid; @strahilevitz2009plasmid].
...
: Gram-positive MIC~90~ values (μg/mL) {#tbl-gram-pos-mic}
...
: Anaerobic activity comparison (MIC~90~ μg/mL) {#tbl-anaerobic}
...
: Mycobacterial MIC values (μg/mL) {#tbl-mycobacterial}
...
: Atypical pathogen MIC values (μg/mL) {#tbl-atypical}
...
Aluminum-, magnesium-, and calcium-containing antacids, sucralfate, iron supplements, and zinc-containing multivitamins markedly reduce quinolone absorption. Take quinolones 2 hours before or 2–6 hours after these agents [@radandt1992interactions].
:::
...
Quinolones are highly effective for UTIs, with urinary concentrations providing substantial therapeutic ratios against most pathogens [@gupta2011acute; @hooton2012uncomplicated].
...
Fluoroquinolones achieve therapeutic concentrations in prostatic tissue and are first-line for chronic bacterial prostatitis. Treatment duration: 4–6 weeks [@naber2008prostatitis].

### Sexually Transmitted Infections

::: {.callout-warning}
## Gonorrhea Resistance
Due to increasing resistance, quinolones are no longer recommended for empirical treatment of gonorrhea in most areas. Use only if susceptibility is confirmed [@hooper1989treatment].
:::
...
::: {.callout-tip}
## CAP Guidelines
Reserve respiratory fluoroquinolones for patients with comorbidities, recent antibiotic use, or in areas with high macrolide resistance [@mandell2007idsa; @metlay2019cap].
:::
...
Fluoroquinolones achieve adequate bone concentrations and have good oral bioavailability, allowing transition from IV to oral therapy [@berbari2015osteomyelitis; @lipsky2004diabetic].
...
::: {.callout-warning}
## C. difficile Risk
All antibiotics increase *C. difficile* infection risk. Quinolones have been associated with outbreaks of the hypervirulent NAP1/BI/027 strain [@lode2003adverse].
:::
...
- Rarely: seizures (particularly with high doses, renal impairment, or concurrent NSAIDs) [@lode2003adverse]

### Musculoskeletal

::: {.callout-important}
## FDA Black Box Warning
Fluoroquinolones are associated with tendinitis and tendon rupture, particularly in patients >60 years, those on corticosteroids, and organ transplant recipients. The Achilles tendon is most commonly affected [@stahlmann2010tendon].
:::
...
QT prolongation is a class effect, varying by agent [@yap2003qt]:

![QT prolongation risk with quinolones](fluoroquinolone-images/qtx.png){#fig-qt fig-align="center" width="80%"}
...
Both hypo- and hyperglycemia reported, particularly with [@fda2018fluoroquinolone]:
...
::: {.callout-important}
## FDA Warning
Peripheral neuropathy may occur rapidly (within days) and may be irreversible. Discontinue immediately if symptoms develop [@fda2018fluoroquinolone].
:::
...
**Pediatrics:** Generally avoided due to concerns about cartilage toxicity, though ciprofloxacin approved for specific indications [@lode2003adverse].
...
: Agent selection by clinical scenario {#tbl-agent-selection}
